...
public class HashAlgorithms {
    ...
    public static void main(String argv[]){
        ...
        double wucha = Math.pow((1-Math.exp(-k *numberOfElements / bitSetSize2)), k);
        System.out.println(wucha);

        //log2(1/e)1.44=9.6，
        double wantedPass = 0.001;
        double xx = Math.log(1/wantedPass)*1.44;
        bitSetSize = (int) (xx * numberOfElements);
        //System.out.println(xx+" ");
        System.out.println("xx:"+xx+" K:"+k+" m:"+bitSetSize+" bytes:"+(bitSetSize/8)+" KB:"+(bitSetSize/8/1024));
