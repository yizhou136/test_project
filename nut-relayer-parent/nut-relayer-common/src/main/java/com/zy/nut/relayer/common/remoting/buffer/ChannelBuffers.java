...
import com.zy.nut.relayer.common.transporter.netty.Netty4BackedChannelBufferFactory;
...
public final class ChannelBuffers {
    ...
    public static ChannelBuffer buffer(int capacity) {
        ...
        if (capacity == 0) {
            return Netty4BackedChannelBufferFactory.getInstance().getBuffer();
        }
        return Netty4BackedChannelBufferFactory.getInstance().getBuffer(capacity);
    }
    ...
    public static ChannelBuffer wrappedBuffer(ByteBuffer buffer) {
        ...
        if (buffer.hasArray()) {
            ...
            return Netty4BackedChannelBufferFactory.getInstance().getBuffer(buffer);
        }
    }
